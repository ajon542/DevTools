...
>
  ...
  <xsl:variable name="IsNVRAMObject" select="false()"/>
...
// Note: requires additional types generated from: <xsl:value-of select="."/>
</xsl:template>
 

  <xsl:template match="FileDescriptorProto/options">
	<xsl:if test="optimize_for[text()='CODE_SIZE']">
	<xsl:variable name="IsNVRAMObject" select="true()"/>
	</xsl:if>
  </xsl:template>
  ...
  [<xsl:if test="$optionFullFramework">global::System.Serializable,</xsl:if>global::ProtoBuf.ProtoContract(Name=@"<xsl:value-of select="name"/>"<xsl:if test="$IsNVRAMObject">,IsNVObject=true</xsl:if>)]
  ...
  <xsl:template match="FieldDescriptorProto[label='LABEL_OPTIONAL' or not(label)]">
    ...
    [<xsl:apply-templates select="." mode="checkDeprecated"/> global::ProtoBuf.ProtoMember(<xsl:value-of select="number"/>, IsRequired = false, Name=@"<xsl:value-of select="name"/>", DataFormat = global::ProtoBuf.DataFormat.<xsl:value-of select="$format"/> <xsl:if test="options/maxsize">,MaxSize=<xsl:value-of select="options/maxsize"/></xsl:if>)] <!---->
  ...
  <xsl:template match="FieldDescriptorProto[label='LABEL_REQUIRED']">
    ...
    [<xsl:apply-templates select="." mode="checkDeprecated"/>global::ProtoBuf.ProtoMember(<xsl:value-of select="number"/>, IsRequired = true, Name=@"<xsl:value-of select="name"/>", DataFormat = global::ProtoBuf.DataFormat.<xsl:value-of select="$format"/> <xsl:if test="options/maxsize">,MaxSize=<xsl:value-of select="options/maxsize"/></xsl:if>)]<!--
    --><xsl:if test="$optionXml">
    [global::System.Xml.Serialization.XmlElement(@"<xsl:value-of select="name"/>", Order = <xsl:value-of select="number"/>)]
    </xsl:if><xsl:if test="$optionDataContract">
  ...
  <xsl:template name="WriteGetSet">
    ...
    <xsl:if test="options/maxsize">
    public int <xsl:value-of select="$name"/>_maxsize() {
        return <xsl:value-of select="options/maxsize"/>;	
    }</xsl:if>
    ...
    public bool <xsl:value-of select="$nameNoKeyword"/>Specified
    {
      ...
      // template for modifying set function 2
    }
  ...
  <xsl:template match="FieldDescriptorProto[label='LABEL_REPEATED']">
    ...
    [<xsl:apply-templates select="." mode="checkDeprecated"/>global::ProtoBuf.ProtoMember(<xsl:value-of select="number"/>, Name=@"<xsl:value-of select="name"/>", DataFormat = global::ProtoBuf.DataFormat.<xsl:value-of select="$format"/><xsl:if test="options/packed='true'">, Options = global::ProtoBuf.MemberSerializationOptions.Packed</xsl:if><xsl:if test="options/maxelements">,MaxElements=<xsl:value-of select="options/maxelements"/></xsl:if>)]<!--
    --><xsl:if test="$optionDataContract">
    [global::System.Runtime.Serialization.DataMember(Name=@"<xsl:value-of select="name"/>", Order = <xsl:value-of select="number"/>, IsRequired = false)]
    ...
    <xsl:if test="options/maxelements">
    public int <xsl:call-template name="pascal"/>_maxelements() {
       return <xsl:value-of select="options/maxelements"/>;	
    }</xsl:if>
  </xsl:template>
